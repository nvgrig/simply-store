package ru.nvgrig.admin.config;
...
import ru.nvgrig.admin.web.client.OauthHttpHeaderProvider;
...
public class SecurityBeans {
    ...
    @Bean
    public OauthHttpHeaderProvider oauthHttpHeaderProvider(
            ClientRegistrationRepository clientRegistrationRepository,
            OAuth2AuthorizedClientService authorizedClientService
    ) {
        return new OauthHttpHeaderProvider(
